...
export function BillingPage() {
  ...
  const query = useMemo(() => ({ invoicePage, paymentPage, search, invoiceStatus, paymentStatus }), [invoicePage, paymentPage, search, invoiceStatus, paymentStatus]);
  const { overview, invoices, payments, error, loading, reload, canViewInvoices, canViewPayments } = useBilling(query);
  ...
  return <section aria-labelledby="billing-title">
    ...
    {loading && <LoadingState label="Loading billing overview..." />}
